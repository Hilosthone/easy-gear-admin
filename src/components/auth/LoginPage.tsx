          ...
          <div className='space-y-2'>
            ...
            <div className='relative'>
              ...
              <input
                type='email'
                required
                className='w-full pl-10 pr-4 py-3 border border-slate-500 rounded-xl outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition-all'
          ...
          <div className='space-y-2'>
            ...
            <div className='relative'>
              ...
              <input
                type='password'
                required
                className='w-full pl-10 pr-4 py-3 border border-slate-700 rounded-xl outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition-all'
                placeholder='••••••••'
              />
            </div>
          </div>
