...
//                 type='email'
//                 required
//                 className='w-full pl-10 pr-4 py-3 border border-slate-300 rounded-xl outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition-all text-black placeholder:text-slate-600'
...
//                 required
//                 className='w-full pl-10 pr-12 py-3 border border-slate-300 rounded-xl outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition-all text-black placeholder:text-slate-600'
//                 placeholder='••••••••'
//               />
//               {/* Toggle Button */}
//               <button
